...
<h1 class="font-weight-bold text-center mb-5 mt-4">Sobre nosotros</h1>
<p class="lead">Mi nombre es Andres Marino, tengo 20 años. Vivo en Coronel Suarez, Argentina.</p>
<p class="lead">Estoy cursando la Tecnicatura en Desarrollo de Aplicaciones Web, este es mi 2do año.</p>
<p class="lead">
...
<p class="float-left">Si desea leer la consigna completa, precione el siguiente boton:</p>
